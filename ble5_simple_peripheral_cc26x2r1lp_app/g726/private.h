...
int predictor_zero_g726(	g726_state *state_ptr);
int predictor_pole_g726(	g726_state *state_ptr);
int step_size_g726(	g726_state *state_ptr);
int quantize_g726(	int		d,	/* Raw difference signal sample */
	int		y,	/* Step size multiplier */
	int *	table,	/* quantization table */
	int		size);	/* table size of short integers */
int reconstruct_g726(	int		sign,	/* 0 for non-negative value */
	int		dqln,	/* G.72x codeword */
	int		y);	/* Step size multiplier */
void update_g726(	int		code_size,	/* distinguish 723_40 with others */
